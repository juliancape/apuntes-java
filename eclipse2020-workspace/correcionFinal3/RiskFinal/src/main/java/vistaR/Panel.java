...
public class Panel extends JPanel{
    ...
    private JLabel sArgentina = new JLabel("A");
    private JLabel sBolivia = new JLabel("B");
    private JLabel sBrasil = new JLabel("Br");
    private JLabel sChile = new JLabel("C");
    private JLabel sColombia = new JLabel("Co");
    private JLabel sEcuador = new JLabel("E");
    private JLabel sGuyana = new JLabel("G");
    private JLabel sGuyanaFrancesa = new JLabel("GF");
    private JLabel sParaguay = new JLabel("P");
    private JLabel sPeru = new JLabel("Pe");
    private JLabel sSuriname = new JLabel("S");
    private JLabel sUruguay = new JLabel("U");
    private JLabel sVenezuela = new JLabel("V");
    ...
    public void labels(){
        sColombia.setBounds(0, 0, 100, 60);
        sColombia.setForeground(Color.RED);
        sColombia.setBackground(Color.red);
        this.add(sColombia);
    }
    ...
    public void updateSColombia(String s){
        this.sColombia.setText(s);
    }
}
